                        ...
                        updateHead: function(e) {
                            ...
                            n !== document.title && (document.title = n), ['meta', 'base', 'link', 'style', 'script'].forEach(function(e) {
                                !(function(e, t) {
                                    ...
                                    0;
                                    for (
                                        var a = Number(n.content), u = [], c = 0, s = n.previousElementSibling; c < a; c++, s = (null == s ? void 0 : s.previousElementSibling) || null
                                    ) {
                                        var l;
                        ...
                        },
                        {
                            ...
                            value: function() {
                                this.scrollToHash(),
                                    ...
                                    '/_error' !== L.page &&
                                    (L.isFallback ||
                                        (L.nextExport && (g.isDynamicRoute(p.pathname) || location.search, 1)) ||
                                        (L.props && L.props.__N_SSG && (location.search, 1))) &&
                                    p
                                    .replace(p.pathname + '?' + String(_.assign(_.urlQueryToSearchParams(p.query), new URLSearchParams(location.search))), I, {
                                        _h: 1,
                ...
                if (P.ST) {
                    ...
                    e.length &&
                        (performance.measure('Next.js-route-change-to-render', e[0].name, 'beforeRender'),
                            ...
                            H &&
                            (performance.getEntriesByName('Next.js-render').forEach(H), performance.getEntriesByName('Next.js-route-change-to-render').forEach(H)),
            ...
            function ie(e) {
                ...
                var d = h.default.createElement(
                    ...
                    h.default.createElement(
                        ...
                        null,
                        K(r, u),
                        h.default.createElement(w.Portal, { type: 'next-route-announcer' }, h.default.createElement(x.RouteAnnouncer, null))
                    )
                );
                return (
                    (function(e, t) {
                    ...
                    return s(this, function(s) {
                        switch (s.label) {
                            ...
                            case 10:
                                return (
                                    (G = s.sent()),
                                    (l = { App: U, initial: !0, Component: F, props: L.props, err: r }),
        ...
        82392: function(e, t, r) {
            ...
            (t.normalizePathTrailingSlash = function(e) {
                ...
                var t = a.parsePath(e),
                    ...
                    i = t.hash;
                return ''
                    .concat(n.removeTrailingSlash(r))
                    .concat(o)
                    .concat(i);
            }),
            ('function' === typeof t.default || ('object' === typeof t.default && null !== t.default)) &&
                                ...
                                if ((!u || i || u.includes('__next_data_catchall') || u.includes('/_error') || u.includes('/404') || (i = u), i)) {
                                    ...
                                    var h = j.parsePath(e),
                                        v = L.formatNextPathnameInfo(
                                            c({}, k.getNextPathnameInfo(h.pathname, { nextConfig: n, parseData: !0 }), {
                                    ...
                                    if (m.startsWith('/')) {
                                        var g = j.parsePath(m),
                                            _ = L.formatNextPathnameInfo(
                                                c({}, k.getNextPathnameInfo(g.pathname, { nextConfig: n, parseData: !0 }), {
                                                    defaultLocale: r.router.defaultLocale,
                                                    buildId: ''
                                                })
                                            );
                                        ...
                                        if (!t.ok) {
                                            ...
                                            if (!o && 404 === t.status)
                                                if (null == (n = Y(e)) ? void 0 : n.notFound)
                                                    return { dataHref: r, json: { notFound: $ }, response: t, text: e, cacheKey: f };
            ...
            var re = function(e) {
                ...
                ne = (function() {
                    function e(t, r, a, o) {
                                ...
                                if (r) {
                                    if (r.__NA) window.location.reload();
                                        ...
                                        y.change(
                                            ...
                                            n,
                                            a,
                                            Object.assign({}, o, { shallow: o.shallow && y._shallow, locale: o.locale || y.defaultLocale, _h: 0 }),
                                            undefined
                                        );
                                    }
                                } else {
                        ...
                        (this.components = {}),
                        '/_error' !== t &&
                            (this.components[g] = { Component: l, initial: !0, props: i, err: f, __N_SSG: i && i.__N_SSG, __N_SSP: i && i.__N_SSP }),
                        ...
                        if (
                            ...
                            this._initialMatchesMiddlewarePromise = B({ router: this, locale: v, asPath: E }).then(function(e) {
                                return (
                                    ...
                                    y.changeState('replaceState', e ? E : x.formatWithValidation({ pathname: A.addBasePath(t), query: r }), E, S),
                                    e
                                );
                            });
                        }
                                    ...
                                    return u(function() {
                                        ...
                                        return i(this, function(i) {
                                            switch (i.label) {
                                                ...
                                                case 6:
                                                    return (
                                                        i.trys.push([6, 8, , 9]), [4, Promise.all([l.pageLoader.getPageList(), p.getClientBuildManifest(), l.pageLoader.getMiddleware()])]
                                                    );
                                                case 7:
                                                ...
                                                case 9:
                                                    return (
                                                        ...
                                                        (ae = n),
                                                        (Q = Q ? d.removeTrailingSlash(R.removeBasePath(Q)) : Q), [4, B({ asPath: n, locale: m.locale, router: l })]
                                                    );
                                                case 10:
                                                    if (((oe = i.sent()), a.shallow && oe && (Q = l.pathname), f && '/_error' !== Q))
                                                        if (((a._shouldResolveHref = !0), n.startsWith('/'))) {
                                                            ...
                                                            oe || (ae = ie.asPath),
                                                                ie.matchedPage &&
                                                                ie.resolvedHref &&
                                                                ((Q = ie.resolvedHref), (X.pathname = A.addBasePath(Q)), oe || (r = x.formatWithValidation(X)));
                                                        } else
                                                            (X.pathname = G(Q, J)),
                                                            X.pathname !== Q && ((Q = X.pathname), (X.pathname = A.addBasePath(Q)), oe || (r = x.formatWithValidation(X)));
                                                    if (!H(n)) return te({ url: n, router: l }), [2, !1];
                                                    if (
                                                        ((ae = C.removeLocale(R.removeBasePath(ae), m.locale)), (ue = d.removeTrailingSlash(Q)), (ce = !1), b.isDynamicRoute(ue))
                                                    )
                                                        if (
                                                            ...
                                                            de ?
                                                            (n = x.formatWithValidation(Object.assign({}, se, { pathname: pe.result, query: U(Y, pe.params) }))) :
                                                            Object.assign(Y, ce);
                                                ...
                                                case 12:
                                                    if (
                                                        ...
                                                        return 'redirect-internal' === ye.type ?
                                                            ...
                                                            (te({ url: ye.destination, router: l }), [2, new Promise(function() {})]);
                                                    if (
                                                        ((Se = ye.error),
                                                            (Ee = ye.props),
                                                            (Oe = ye.__N_SSG),
                                                    ...
                                                    if (Ee.pageProps && Ee.pageProps.__N_REDIRECT)
                                                        return (
                                                            ...
                                                            (((Ce = P.parseRelativeUrl(Me)).pathname = G(Ce.pathname, J)),
                                                                (Re = z(l, Me, Me)),
                                                                (Ae = Re.url),
                                                                (Te = Re.as), [2, l.change(t, Ae, Te, a)]) :
                                                ...
                                                case 2:
                                                    if (
                                                        ((u = i.sent()),
                                                            (l = u.page),
                                                            (f = u.styleSheets),
                                                            (d = { props: undefined, Component: l, styleSheets: f, err: t, error: t }).props)
                                                    )
                                                        return [3, 6];
                                                    i.label = 3;
                                                case 3:
                                            ...
                                            switch (I.label) {
                                                        ...
                                                        (f && (w = void 0),
                                                            ...
                                                            (E = {
                                                                dataHref: m.pageLoader.getDataHref({
                                                                    href: x.formatWithValidation({ pathname: r, query: n }),
                                                                    skipInterpolation: !0,
                                                                    asPath: o,
                                                                    locale: l
                                                                }),
                                                ...
                                                case 2:
                                                    return (
                                                        (O = I.sent()),
                                                        P(),
                                                        'redirect-internal' === (null == O || null == (g = O.effect) ? void 0 : g.type) ||
                                                        'redirect-external' === (null == O || null == (_ = O.effect) ? void 0 : _.type) ?
                                                        [2, O.effect] :
                                                ...
                                                case 5:
                                                    return (
                                                        ...
                                                        j.__N_SSG &&
                                                        J(Object.assign({}, E, { isBackground: !0, persistCache: !1, inflightCache: X })).catch(function() {}),
                                            ...
                                            switch (i.label) {
                                                case 0:
                                                    return N.isBot(window.navigator.userAgent) ?
                                                        [2] :
                                                        ((a = P.parseRelativeUrl(e)), (o = a.pathname), (u = a.query), [4, n.pageLoader.getPageList()]);
                                                case 1:
                                                    return (
                                                        (c = i.sent()),
                                                        (s = t),
                                                ...
                                                case 2:
                                                    if (
                                                        ...
                                                        return [2];
                                                    (s = C.removeLocale(R.removeBasePath(v.asPath), n.locale)),
                                                    v.matchedPage && v.resolvedHref && ((o = v.resolvedHref), (a.pathname = o), (e = x.formatWithValidation(a))),
                                                        (i.label = 3);
                                                case 3:
                                                    return (
                                                        ...
                                                        ((o = a.pathname),
                                                            (a.pathname = o),
                                                            Object.assign(u, E.getRouteMatcher(O.getRouteRegex(a.pathname))(j.parsePath(t).pathname) || {}),
                        ...
                        switch (i.label) {
                            case 0:
                                return (
                                    ...
                                    e.getInitialProps ? [3, 3] : t.ctx && t.Component ? ((n = {}), [4, h(t.Component, t.ctx)]) : [3, 2]
                                );
                            case 1:
                        ...
                        return (function(u) {
                            ...
                            for (; o && ((o = 0), u[0] && (i = 0)), i;)
                                try {
                                    if (
                                        ((r = 1),
                                            n && (a = 2 & u[0] ? n.return : u[0] ? n.throw || ((a = n.return) && a.call(n), 0) : n.next) && !(a = a.call(n, u[1])).done)
                                    )
                                        return a;
