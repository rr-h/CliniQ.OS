      ...
      var M = (function(e) {
        ...
        function c(e) {
          ...
          return (
            ...
            E(x((t = a.call(this, e))), 'onDragStart', function(e, r) {
              if (((0, d.default)('Draggable: onDragStart: %j', r), !1 === t.props.onStart(e, (0, s.createDraggableData)(x(t), r)))) return !1;
              t.setState({ dragging: !0, dragged: !0 });
            }),
            E(x(t), 'onDrag', function(e, r) {
              if (!t.state.dragging) return !1;
              (0, d.default)('Draggable: onDrag: %j', r);
              var n = (0, s.createDraggableData)(x(t), r),
                o = { x: n.x, y: n.y };
              if (t.props.bounds) {
                var a = o.x,
                  i = o.y;
                (o.x += t.state.slackX), (o.y += t.state.slackY);
                var u = O((0, s.getBoundPosition)(x(t), o.x, o.y), 2),
                  l = u[0],
                  c = u[1];
                (o.x = l),
                  (o.y = c),
                  ...
                  (n.x = o.x),
                  (n.y = o.y),
                  (n.deltaX = o.x - t.state.x),
                  (n.deltaY = o.y - t.state.y);
              }
              if (!1 === t.props.onDrag(e, n)) return !1;
              t.setState(o);
            }),
            E(x(t), 'onDragStop', function(e, r) {
              if (!t.state.dragging) return !1;
              if (!1 === t.props.onStop(e, (0, s.createDraggableData)(x(t), r))) return !1;
              (0, d.default)('Draggable: onDragStop: %j', r);
          ...
          (n = [
            {
              ...
              value: function(e, t) {
                ...
                return !r || (n && r.x === n.x && r.y === n.y)
                  ? null
                  : ((0, d.default)('Draggable: getDerivedStateFromProps %j', { position: r, prevPropsPosition: n }),
                    { x: r.x, y: r.y, prevPropsPosition: v({}, r) });
              }
            }
          ]),
          (r = [
            {
              ...
              value: function() {
                'undefined' !== typeof window.SVGElement && this.findDOMNode() instanceof window.SVGElement && this.setState({ isElementSVG: !0 });
              }
            },
            {
            ...
            },
            {
              ...
              value: function() {
                var e,
                  ...
                  m = {},
                  O = null,
                  S = !Boolean(d) || this.state.dragging,
                  w = d || n,
                  D = { x: (0, s.canDragX)(this) && S ? this.state.x : w.x, y: (0, s.canDragY)(this) && S ? this.state.y : w.y };
                this.state.isElementSVG ? (O = (0, l.createSVGTransform)(D, y)) : (m = (0, l.createCSSTransform)(D, y));
                var P = (0, u.default)(r.props.className || '', a, (E((e = {}), i, this.state.dragging), E(e, c, this.state.dragged), e));
                return o.createElement(
                  f.default,
                  b({}, g, { onStart: this.onDragStart, onDrag: this.onDrag, onStop: this.onDragStop }),
                  o.cloneElement(o.Children.only(r), { className: P, style: v(v({}, r.props.style), m), transform: O })
                );
              }
            }
          ]) && w(t.prototype, r),
      ...
      var D = { start: 'touchstart', move: 'touchmove', stop: 'touchend' },
        ...
        x = (function(e) {
          ...
          function s() {
            ...
            return (
              w(O((e = a.call.apply(a, [this].concat(r)))), 'state', { dragging: !1, lastX: NaN, lastY: NaN, touchIdentifier: null }),
              w(O(e), 'mounted', !1),
              w(O(e), 'handleDragStart', function(t) {
                ...
                if (
                  !(
                    ...
                    (e.props.handle && !(0, u.matchesSelectorAndParentsTo)(t.target, e.props.handle, r)) ||
                    (e.props.cancel && (0, u.matchesSelectorAndParentsTo)(t.target, e.props.cancel, r))
                  )
                ) {
                  'touchstart' === t.type && t.preventDefault();
                  var o = (0, u.getTouchIdentifier)(t);
                  e.setState({ touchIdentifier: o });
                  var a = (0, l.getControlPosition)(t, o, O(e));
                  if (null != a) {
                    var i = a.x,
                      s = a.y,
                      f = (0, l.createCoreData)(O(e), i, s);
                    (0, c.default)('DraggableCore: handleDragStart: %j', f),
                      (0, c.default)('calling', e.props.onStart),
                      !1 !== e.props.onStart(t, f) &&
                        !1 !== e.mounted &&
                        (e.props.enableUserSelectHack && (0, u.addUserSelectStyles)(n),
                        e.setState({ dragging: !0, lastX: i, lastY: s }),
                        (0, u.addEvent)(n, j.move, e.handleDrag),
                        (0, u.addEvent)(n, j.stop, e.handleDragStop));
                  }
                }
              }),
              w(O(e), 'handleDrag', function(t) {
                var r = (0, l.getControlPosition)(t, e.state.touchIdentifier, O(e));
                if (null != r) {
                  var n = r.x,
                    o = r.y;
                  ...
                  var s = (0, l.createCoreData)(O(e), n, o);
                  if (((0, c.default)('DraggableCore: handleDrag: %j', s), !1 !== e.props.onDrag(t, s) && !1 !== e.mounted))
              ...
              w(O(e), 'handleDragStop', function(t) {
                if (e.state.dragging) {
                  var r = (0, l.getControlPosition)(t, e.state.touchIdentifier, O(e));
                  if (null != r) {
                    var n = r.x,
                    ...
                    if (Array.isArray(e.props.grid)) {
                      var a = n - e.state.lastX || 0,
                        i = o - e.state.lastY || 0,
                        s = p((0, l.snapToGrid)(e.props.grid, a, i), 2);
                      (a = s[0]), (i = s[1]), (n = e.state.lastX + a), (o = e.state.lastY + i);
                    }
                    var f = (0, l.createCoreData)(O(e), n, o);
                    if (!1 === e.props.onStop(t, f) || !1 === e.mounted) return !1;
                    var d = e.findDOMNode();
                    d && e.props.enableUserSelectHack && (0, u.removeUserSelectStyles)(d.ownerDocument),
                      (0, c.default)('DraggableCore: handleDragStop: %j', f),
                      e.setState({ dragging: !1, lastX: NaN, lastY: NaN }),
                      d &&
                        ((0, c.default)('DraggableCore: Removing handlers'),
                        (0, u.removeEvent)(d.ownerDocument, j.move, e.handleDrag),
                        (0, u.removeEvent)(d.ownerDocument, j.stop, e.handleDragStop));
                  }
                }
              }),
              w(O(e), 'onMouseDown', function(t) {
                return (j = P), e.handleDragStart(t);
              }),
              w(O(e), 'onMouseUp', function(t) {
                return (j = P), e.handleDragStop(t);
              }),
              w(O(e), 'onTouchStart', function(t) {
                return (j = D), e.handleDragStart(t);
              }),
              w(O(e), 'onTouchEnd', function(t) {
                return (j = D), e.handleDragStop(t);
              }),
              e
            );
          }
            ...
            (r = [
              {
                ...
                value: function() {
                  ...
                  e && (0, u.addEvent)(e, D.start, this.onTouchStart, { passive: !1 });
                }
              },
              {
                key: 'componentWillUnmount',
                value: function() {
                  ...
                  if (e) {
                    ...
                    (0, u.removeEvent)(t, P.move, this.handleDrag),
                      (0, u.removeEvent)(t, D.move, this.handleDrag),
                      (0, u.removeEvent)(t, P.stop, this.handleDragStop),
                      (0, u.removeEvent)(t, D.stop, this.handleDragStop),
                      (0, u.removeEvent)(e, D.start, this.onTouchStart, { passive: !1 }),
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return null !== (e = this.props) && void 0 !== e && e.nodeRef
                    ? null === (t = this.props) || void 0 === t || null === (r = t.nodeRef) || void 0 === r
                      ? void 0
                      : r.current
                    : i.default.findDOMNode(this);
                }
    ...
    81825: function(e, t, r) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.createCSSTransform = function(e, t) {
          var r = d(e, t, 'px');
          return s({}, (0, a.browserPrefixToKey)('transform', a.default), r);
        }),
        ...
        (t.innerHeight = function(e) {
          ...
          return (t -= (0, o.int)(r.paddingTop)), (t -= (0, o.int)(r.paddingBottom));
        }),
        (t.innerWidth = function(e) {
          var t = e.clientWidth,
            r = e.ownerDocument.defaultView.getComputedStyle(e);
          return (t -= (0, o.int)(r.paddingLeft)), (t -= (0, o.int)(r.paddingRight));
        }),
        (t.matchesSelector = f),
        ...
        (t.offsetXYFromParent = function(e, t, r) {
          var n = t === t.ownerDocument.body ? { left: 0, top: 0 } : t.getBoundingClientRect(),
            o = (e.clientX + t.scrollLeft - n.left) / r,
            a = (e.clientY + t.scrollTop - n.top) / r;
          return { x: o, y: a };
        }),
        (t.outerHeight = function(e) {
          var t = e.clientHeight,
            r = e.ownerDocument.defaultView.getComputedStyle(e);
          return (t += (0, o.int)(r.borderTopWidth)), (t += (0, o.int)(r.borderBottomWidth));
        }),
        (t.outerWidth = function(e) {
          var t = e.clientWidth,
            r = e.ownerDocument.defaultView.getComputedStyle(e);
          return (t += (0, o.int)(r.borderLeftWidth)), (t += (0, o.int)(r.borderRightWidth));
        }),
        (t.removeClassName = y),
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.createCoreData = function(e, t, r) {
          var o = e.state,
            ...
            u = a(e);
          return i
            ? { node: u, deltaX: 0, deltaY: 0, lastX: t, lastY: r, x: t, y: r }
            : { node: u, deltaX: t - o.lastX, deltaY: r - o.lastY, lastX: o.lastX, lastY: o.lastY, x: t, y: r };
        }),
        ...
        (t.getBoundPosition = function(e, t, r) {
          ...
          if ('string' === typeof i) {
            var l,
              s = u.ownerDocument,
              c = s.defaultView;
            if (!((l = 'parent' === i ? u.parentNode : s.querySelector(i)) instanceof c.HTMLElement))
              throw new Error('Bounds selector "' + i + '" could not find an element.');
            var f = l,
              d = c.getComputedStyle(u),
              p = c.getComputedStyle(f);
            i = {
              left: -u.offsetLeft + (0, n.int)(p.paddingLeft) + (0, n.int)(d.marginLeft),
              top: -u.offsetTop + (0, n.int)(p.paddingTop) + (0, n.int)(d.marginTop),
              right: (0, o.innerWidth)(f) - (0, o.outerWidth)(u) - u.offsetLeft + (0, n.int)(p.paddingRight) - (0, n.int)(d.marginRight),
              bottom: (0, o.innerHeight)(f) - (0, o.outerHeight)(u) - u.offsetTop + (0, n.int)(p.paddingBottom) - (0, n.int)(d.marginBottom)
            };
          }
        ...
        (t.getControlPosition = function(e, t, r) {
          ...
          var i = a(r),
            u = r.props.offsetParent || i.offsetParent || i.ownerDocument.body;
          return (0, o.offsetXYFromParent)(n || e, u, r.props.scale);
        }),
