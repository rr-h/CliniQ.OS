  ...
  [289],
  {
    35361: (t, e, n) => {
      ...
      var r = function () {
          ...
          return e(
            'div',
            {
              ...
              class: {
                'larger-bars': 'large' == t.size,
                'is-playing': t.playing && t.visible
              },
              on: {
                click: t.handleSeek
              }
      ...
      function c(t, e, n) {
        ...
        return (
          i < 0
            ? ((p = Math.pow(10, -i) / l), (f = Math.round(t * p)), (h = Math.round(e * p)), f / p < t && ++f, h / p > e && --h, (p = -p))
            : ((p = Math.pow(10, i) * l), (f = Math.round(t / p)), (h = Math.round(e / p)), f * p < t && ++f, h * p > e && --h),
          h < f && 0.5 <= n && n < 2 ? c(t, e, 2 * n) : [f, h, p]
        );
      }
        ...
        return o === a
          ...
          : o > a
            ...
            : o > 0
              ...
              : '0.' + new Array(1 - o).join('0') + y(t, Math.max(0, e + o - 1))[0];
      }
      ...
      function $(t) {
        ...
        function c(t) {
          ...
          var c = t.fill,
            ...
            b = t.trim,
            w = t.type;
          'n' === w ? ((v = !0), (w = 'g')) : R[w] || (void 0 === y && (y = 12), (b = !0), (w = 'g')),
            (d || ('0' === c && '=' === l)) && ((d = !0), (c = '0'), (l = '='));
          ...
          return (
            (y = void 0 === y ? 6 : /[gprs]/.test(w) ? Math.max(1, Math.min(21, y)) : Math.max(0, Math.min(20, y))),
            (O.toString = function () {
              return t + '';
            }),
            O
      ...
      function F(t) {
        ...
        return (
          2 !== t.length ? ((e = L), (n = (e, n) => L(t(e), n)), (r = (e, n) => t(e) - n)) : ((e = t === L || t === q ? t : H), (n = t), (r = t)),
          {
            left: i,
            center: a,
            right: o
          ...
          (e = et.exec(t))
            ? ((n = e[1].length),
              ...
              6 === n
                ? dt(e)
                : 3 === n
                  ? new yt(((e >> 8) & 15) | ((e >> 4) & 240), ((e >> 4) & 15) | (240 & e), ((15 & e) << 4) | (15 & e), 1)
                  : 8 === n
                    ? gt((e >> 24) & 255, (e >> 16) & 255, (e >> 8) & 255, (255 & e) / 255)
                    : 4 === n
                      ? gt(
                          ((e >> 12) & 15) | ((e >> 8) & 240),
                          ((e >> 8) & 15) | ((e >> 4) & 240),
                      ...
                      : null)
            : (e = nt.exec(t))
              ? new yt(e[1], e[2], e[3], 1)
              : (e = rt.exec(t))
                ? new yt((255 * e[1]) / 100, (255 * e[2]) / 100, (255 * e[3]) / 100, 1)
                : (e = it.exec(t))
                  ? gt(e[1], e[2], e[3], e[4])
                  : (e = ot.exec(t))
                    ? gt((255 * e[1]) / 100, (255 * e[2]) / 100, (255 * e[3]) / 100, e[4])
                    : (e = at.exec(t))
                      ? Mt(e[1], e[2] / 100, e[3] / 100, 1)
                      : (e = st.exec(t))
                        ? Mt(e[1], e[2] / 100, e[3] / 100, e[4])
                        : ut.hasOwnProperty(t)
                          ? dt(ut[t])
                          : 'transparent' === t
      ...
      function Gt(t, e) {
        var n,
          r,
          i,
          o = (Vt.lastIndex = Wt.lastIndex = 0),
          a = -1,
          s = [],
          u = [];
        (t += ''), (e += '');
        while ((n = Vt.exec(t)) && (r = Wt.exec(e)))
      ...
      function se(t, e, n) {
        var r = t[0],
          ...
          a = e[1];
        return (
          i < r ? ((r = oe(i, r)), (o = n(a, o))) : ((r = oe(r, i)), (o = n(o, a))),
          function (t) {
            return o(r(t));
          }
        );
      ...
      function ge(t) {
        ...
        function r() {
          return 1 === n ? t(ie, ie) : 0.5 === n ? t(pe, de) : t(he(n), he(1 / n));
        }
        return (
              ...
              'undefined' !== typeof document.hidden
                ...
                : 'undefined' !== typeof document.mozHidden
                  ...
                  : 'undefined' !== typeof document.msHidden
                    ...
                    : 'undefined' !== typeof document.webkitHidden && (t = 'webkitvisibilitychange'),
              document.addEventListener(t, this.checkFocus),
    ...
    55448: (t, e, n) => {
      ...
      t.exports = function (t) {
        return new Promise(function (e, n) {
          ...
          if (
            (b.open(t.method.toUpperCase(), a(E, t.params, t.paramsSerializer), !0),
            (b.timeout = t.timeout),
            'onloadend' in b
              ? (b.onloadend = N)
    ...
    51609: (t, e, n) => {
      ...
      var c = u(s);
      (c.Axios = o),
        (c.CanceledError = n(60644)),
        (c.CancelToken = n(14972)),
        (c.isCancel = n(26502)),
        (c.VERSION = n(97288).version),
        (c.toFormData = n(47675)),
        (c.AxiosError = n(82648)),
    ...
    13572: (t, e, n) => {
      ...
      t.exports = function (t) {
        ...
        return e(t).then(
          ...
          function (e) {
            return (
              o(e) || (u(t), e && e.response && (e.response.data = i.call(t, e.response.data, e.response.headers, t.transformResponse))),
              Promise.reject(e)
            );
          }
        );
              ...
              i.forEach(t, function (t, n) {
                if (!i.isUndefined(t)) {
                  ...
                  if (t && !r && 'object' === typeof t)
                    ...
                    else if (i.endsWith(n, '[]') && (s = i.toArray(t)))
    ...
    54875: (t, e, n) => {
      ...
      (o.transitional = function (t, e, n) {
        ...
        return function (n, r, s) {
          ...
          return (
            e && !a[r] && ((a[r] = !0), console.warn(o(r, ' has been deprecated since v' + e + ' and will be removed in the near future'))),
            !t || t(n, r, s)
          );
        };
      }),
    ...
    64867: (t, e, n) => {
      ...
      function R(t, e) {
        if (null !== t && 'undefined' !== typeof t)
          if (('object' !== typeof t && (t = [t]), s(t))) for (var n = 0, r = t.length; n < r; n++) e.call(null, t[n], n, t);
    ...
    98513: (t, e, n) => {
      ...
      const o = {
        get(t, e, n) {
          ...
          let r = {};
          return (
            e && e.auth && (r['Authorization'] = `OAuth ${e.auth}`),
            !(!e || !e.firebase) && (r['Poolsuite-Firebase-Access-Token'] = e.firebase),
            e && e.platform && (r['Poolsuite-Platform'] = e.platform),
            i()({
              method: 'GET',
              url: t,
              data: n,
