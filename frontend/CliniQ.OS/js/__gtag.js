  ...
  var data = {
    resource: {
      ...
      macros: [
        ...
        { function: "__c", vtp_value: "google.co.uk" },
      ...
      tags: [
        ...
        },
        {
          ...
          priority: 12,
          vtp_instanceDestinationId: "G-E5B3WC78SV",
          tag_id: 24,
        },
        {
...
*/
          ...
          b.addEventListener(function (c) {
            if (c.internalErrorState !== 0)
                    ...
                    if (h === "1") {
                      ...
                      m = In(n)
                        ? n.gdprApplies === !1
                          ...
                          ? !p.Mj
                          : (p.Mj || n.gdprApplies !== void 0 || p.Fl) &&
                            (p.Mj ||
              ...
              if (d) {
                ...
                a.gdprApplies !== !0
                  ? (sm([Q.g.T, Q.g.Aa, Q.g.P]), (Ql().active = !0))
                  : ((r[Q.g.Aa] =
                      a.mc["3"] && a.mc["4"] ? "granted" : "denied"),
                    typeof a.tcfPolicyVersion === "number" &&
                    a.tcfPolicyVersion >= 4
                      ? (r[Q.g.P] =
                          a.mc["1"] && a.mc["7"] ? "granted" : "denied")
                      : sm([Q.g.P]),
                    mm(
                      r,
                      { eventId: 0 },
  ...
  var io = function (a) {
      if (U(60) && Jl() === "US-CO" && qc.globalPrivacyControl === !0)
        return !1;
      var b = ho(a);
      if (b === 3) return !1;
      switch ($l(Q.g.Aa)) {
    ...
    lo = {},
    mo =
      ((lo[Q.g.T] = 0), (lo[Q.g.W] = 1), (lo[Q.g.P] = 2), (lo[Q.g.Aa] = 3), lo);
  function no(a) {
    switch (a) {
      case void 0:
        return 1;
  ...
  var oo = function (a) {
      for (var b = "1", c = 0; c < eo.length; c++) {
        ...
        b =
          ...
          ("" +
            ...
            "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[
              (no(m.declare) << 4) | (no(m.default) << 2) | no(m.update)
            ]);
      }
      var n = b,
        p;
    ...
    po = function () {
      if (!Zl(Q.g.P)) return "-";
      for (
        var a = Object.keys(li), b = am(a), c = "", d = pa(a), e = d.next();
        !e.done;
        e = d.next()
      ) {
        var f = e.value;
  ...
  var uo = { UA: 1, AW: 2, DC: 3, G: 4, GF: 5, GT: 12, GTM: 14, HA: 6, MC: 7 };
  function vo(a) {
    a = a === void 0 ? {} : a;
    ...
    L = L === void 0 ? {} : L;
    for (
      var O = [], S = pa(Object.keys(L)), ba = S.next();
      !ba.done;
      ba = S.next()
    ) {
      var aa = ba.value;
  ...
  function yo(a) {
    if (!xo) {
      xo = {};
      for (var b = pa(Object.keys(wo)), c = b.next(); !c.done; c = b.next())
        xo[wo[c.value]] = !0;
    }
    return !!xo[a];
  }
  ...
  function Po(a, b) {
    return (
      a !== void 0 &&
      (So.test(window.document.location.hostname) || (b === "/" && Ro.test(a)))
    );
  }
  function To(a) {
    if (!a) return 1;
  ...
  function sp(a, b) {
    ...
    c(f, !0, !1);
    Yi(1) && c(g, !0, !0);
    for (var m in h) h.hasOwnProperty(m) && vp(m, h[m], a);
  }
  function vp(a, b, c) {
    c.tagName.toLowerCase() === "a"
      ? up(a, b, c)
      : c.tagName.toLowerCase() === "form" && tp(a, b, c);
  }
  ...
  function Jp(a, b) {
    var c = b.split(".");
    c.length === 5
      ? ((Bp[a] = c.slice(0, 2).join(".")),
        (Cp[a] = { id: c.slice(2, 4).join("."), Bh: Number(c[4]) || 0 }))
      : c.length === 3
      ? (Cp[a] = { id: c.slice(0, 2).join("."), Bh: Number(c[2]) || 0 })
      : (Bp[a] = b);
  }
  function Ep(a) {
    return (a || "_gcl") + "_au";
  ...
  function Op(a, b) {
    ...
    for (var e = 0; e < c.length; e++) {
      ...
      if (
        ...
        d[c[e].Uh] || (d[c[e].Uh] = []);
        var g = { version: f[0], timestamp: Number(f[1]) * 1e3, ba: f[2] };
  ...
  var Rp = {},
    Up =
      ((Rp[5] = { mk: { 2: Sp }, Yg: ["k", "i", "b"] }),
      (Rp[4] = { mk: { 2: Sp, GCL: Tp }, Yg: ["k", "i", "b"] }),
      Rp);
  function Vp(a) {
    var b = Up[5];
    if (b) {
  ...
  function Sp(a, b) {
    ...
    if (c.length === 3) {
      ...
      if (e) {
        for (
          var f = e.Yg, g = pa(c[2].split("$")), h = g.next();
          !h.done;
          h = g.next()
        ) {
          var m = h.value,
      ...
      d.ve
        ? d.ve.Oh
          ? (a[e] = Array.isArray(f)
              ...
              : void 0)
          : (typeof f === "string" && aq(f, d.ve)) || (a[e] = void 0)
        : (a[e] = void 0);
    }
  }
  var bq = /^\w+$/,
  ...
  function pq(a, b, c, d, e) {
    ...
    f
      ? ((f.timestamp = Math.max(f.timestamp, d)),
        (f.labels = qq(f.labels || [], e || [])))
      : a.push({ version: b, ba: c, timestamp: d, labels: e });
  }
  function oq(a) {
    for (
      var b = Yp(a) || [], c = [], d = pa(b), e = d.next();
      !e.done;
      e = d.next()
    ) {
      var f = e.value,
  ...
  function jq(a) {
    for (
      var b = [], c = Fo(a, H.cookie, void 0, fq()), d = pa(c), e = d.next();
      !e.done;
      e = d.next()
    ) {
      var f = sq(e.value);
        ...
        if (gq(m)) {
          ...
          if (!n && a.gb) {
            var x = a.gb[0],
              B = nq("gb", f);
            (!b &&
              jq(B).some(function (F) {
                return F.ba === x && F.labels && F.labels.length > 0;
              })) ||
              t("gb", u(x));
          }
        }
      ...
      for (var d = mq(b.prefix), e = 0; e < a.length; ++e) {
        ...
        if (eq[f] !== void 0) {
          ...
          if (h) {
            ...
            b: {
              for (
                var p = m, q = Fo(g, H.cookie, void 0, fq()), r = 0;
                r < q.length;
                ++r
              )
                if (Bq(q[r]) > p) {
  ...
  function Gq(a, b) {
    if (Eo(G)) {
      for (var c = mq(b.prefix), d = {}, e = 0; e < a.length; e++)
        eq[a[e]] && (d[a[e]] = eq[a[e]]);
      hq(function () {
        z(d, function (f, g) {
  ...
  var Sq = function (a, b, c) {
    ...
    dr = function (a, b, c, d, e) {
      var f = wq(),
        ...
        q = Tq();
      !h ||
        (n !== "aw.ds" && n !== "aw" && n !== "ds" && n !== "3p.ds") ||
        g.push({ ba: h, Ae: n });
      m && g.push({ ba: m, Ae: "ds" });
      g.length === 2 && P(147);
      g.length === 0 && f.wbraid && g.push({ ba: f.wbraid, Ae: "gb" });
      g.length === 0 && n === "aw.ds" && g.push({ ba: "", Ae: "aw.ds" });
      Zq(function () {
        if (U(76) || X(Q.g.T)) {
          var r = X(Xq());
          Dp(a);
              ...
              for (var S = 0; S < x.length; S++) {
                ...
                if (!Sq(a.prefix, R + "." + aa, u !== void 0)) {
                  ...
                  aa !== ""
                    ...
                    : R === "aw.ds" && (oa += "&gclsrc=aw.ds");
                  Kc(oa);
                }
              }
            else if (
              (p || q !== void 0) &&
              !Sq(a.prefix, "gad", u !== void 0)
            ) {
              var ka = O + "?" + t.join("&");
              Kc(ka);
            }
  ...
  function ur(a, b) {
    if (rr.test(H.location.host)) {
      ...
      return c && c.length === 2 && c[1].match(pr)
  ...
  function yr(a, b, c) {
    if (rr.test(H.location.host)) {
      ...
      if (b === "braids") return lq({ prefix: a });
    }
    return [];
  }
  function zr(a) {
    return yr(a, "gclid", "gclaw")
      .map(function (b) {
        return b.ba;
      })
      .join(".");
  ...
  var Hr = function (a) {
        ...
        if (U(17)) {
          ...
          if (e) a.isAborted = !0;
            ...
            if (a.metadata.consent_updated)
              ...
              a.C[Q.g.Gd] ||
                a.C[Q.g.Nd] ||
                ((a.C[Q.g.Te] = p.wbraid), (a.C[Q.g.cg] = p.gbraid));
    ...
    Ir = function (a, b) {
      ...
      m = a.On;
      n = a.ik;
      Gr({ sd: c, xd: d, Dd: e, kc: b });
      c &&
        m !== !0 &&
        (n != null ? (n = String(n)) : (n = void 0), dr(b, f, g, h, n));
    },
    Gr = function (a) {
      var b, c, d, e;
      b = a.sd;
      ...
      e = a.kc;
      b &&
        (zp(c[Q.g.Bc], !!c[Q.g.X]) && (Aq(Jr, e), Cq(e), Lp(e)),
        xq(e),
        Gq(Jr, e),
        Hq(e));
      c[Q.g.X] &&
        (Eq(Jr, c[Q.g.X], c[Q.g.Jb], !!c[Q.g.tb], e.prefix),
        Fq(c[Q.g.X], c[Q.g.Jb], !!c[Q.g.tb], e.prefix),
        Mp(Ep(e.prefix), c[Q.g.X], c[Q.g.Jb], !!c[Q.g.tb], e),
    ...
    Lr = function (a, b, c, d) {
      ...
      if (typeof f === "function")
        ...
        } else e === Q.g.Eb ? (P(65), Dp(b, !1), f(Bp[Ep(b.prefix)])) : f(g);
    },
    Jr = ["aw", "dc", "gb"],
    Kr = ["aw", "dc", "gb", "ag"];
  function Mr(a) {
    var b = W(a.o, Q.g.Ib),
      c = W(a.o, Q.g.Xb);
    b && !c
      ? (a.eventName !== Q.g.da && a.eventName !== Q.g.Nc && P(131),
        (a.isAborted = !0))
  ...
  var us = function (a) {
    ...
    xs = function (a, b, c) {
      ...
      if (ss) {
        ...
        return ws(
          function (f) {
            e = !0;
            for (var g = { Ee: 0 }; g.Ee < f.length; g = { Ee: g.Ee }, g.Ee++)
              I(
                (function (h) {
                  return function () {
                    a(f[h.Ee]);
    ...
    ws = function (a, b, c) {
      for (
        ...
        d.observe(b[e]);
      for (var f = 0; f < ts.length; f++) if (!ts[f]) return (ts[f] = d), f;
      return ts.push(d) - 1;
    },
    ts = [],
  ...
  var zs = function (a, b, c) {
    ...
    As = function (a, b, c) {
      return zs({ element: a.element, Z: a.Z, sa: "1" }, b, c);
    },
    Bs = function (a) {
      var b = !!a.vd + "." + !!a.wd;
    ...
    Ls = function () {
      ...
      for (
        ...
        var e = c[d];
        if (
          !(Is.indexOf(e.tagName.toUpperCase()) >= 0) &&
  ...
  var Gs = /[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}/i,
    ...
    Js = ["BR"],
    Os = { on: "1", Bn: "2", sn: "3", vn: "4", ln: "5", Cn: "6", xn: "7" },
    Ps = {},
    Ks = ["INPUT", "SELECT"];
  var ht = function (a) {
      a = a || { vd: !0, wd: !0, Pf: void 0 };
      ...
      Ps[b] = { timestamp: Db(), result: D };
      return D;
    },
    it = function (a) {
      return (
        a.tagName + ":" + a.isVisible + ":" + a.Z.length + ":" + Ns.test(a.Z)
      );
    };
  var kt = function (a) {
  ...
  function eu(a, b) {
    ...
    if ((n = e.length >= 1)) {
      ...
      p !== void 0 && Db() - p < (Xi[1] === void 0 ? 6e4 : Xi[1])
        ? (mb("TAGGING", 9), (n = !0))
        : (n = !1);
    }
    if (!n) {
  ...
  var Zu = function (a, b) {
      ...
      z(a.C, function (f, g) {
        ...
        h &&
          ...
          g !== "" &&
          (!a.metadata.redact_click_ids ||
            (f !== Q.g.Gd && f !== Q.g.Nd && f !== Q.g.Te && f !== Q.g.cg) ||
            (g = "0"),
          d(h, g));
      });
      d("gtm", vo({ za: a.metadata.source_canonical_id }));
      jo() && d("gcs", ko());
      d("gcd", oo(a.o));
      ro() && d("dma_cps", po());
      d("dma", qo());
    ...
    Yu =
      ...
      (av[Q.g.Fa] = "dr"),
      (av[Q.g.jf] = "ga_uid"),
      (av[Q.g.Cc] = "gdpr_consent"),
      (av[Q.g.Da] = "uid"),
      (av[Q.g.ee] = "us_privacy"),
      (av[Q.g.Ob] = "npa"),
      av);
  var bv = {
    N: {
  ...
  function yw() {
    ...
    uw.test(G.location && G.location.hostname) &&
      (si
        ? P(116)
        : (P(117),
          zw &&
          ...
          if (!p) {
            ...
            m && tc && h
              ? ((q = tc.replace(/^(?:https?:\/\/)?/i, "").split(/[?#]/)[0]),
                (p = Vr("https://", "http://", q + g)))
              : (p = Fi.F ? Gi() + n + g : Vr("https://", "http://", q + g));
          }
          d.siloed && fk({ ctid: f, isDestination: !1 });
          var r = Qj();
      ...
      if (!Bw()) {
        ...
        if (!ek(e))
          if (!c.siloed && gk())
            ...
            c.siloed && fk({ ctid: e, isDestination: !0 });
            Cj().destination[e] = { state: 1, context: c, parent: Qj() };
            Bj({ ctid: e, isDestination: !0 }, d);
            Ac(g);
          }
      }
  ...
  Kw.prototype.addListener = function (a, b, c) {
    var d = ++this.M;
    this.m[a] = this.m[a] || {};
    this.m[a][String(d)] = { listener: b, Cb: c };
    return d;
  };
  Kw.prototype.F = function (a, b) {
    var c = this.m[a],
      d = String(b);
    if (!c || !c[d]) return !1;
    delete c[d];
  ...
  Kw.prototype.J = function (a, b) {
    var c = [];
    z(this.m[a], function (d, e) {
      c.indexOf(e.listener) < 0 &&
        (e.Cb === void 0 || b.indexOf(e.Cb) >= 0) &&
        c.push(e.listener);
    });
    return c;
  };
  ...
  function Nx(a, b, c, d) {
    zj &&
      ...
      ((d === void 0 ? 0 : d)
        ? ((Mx[b] = Mx[b] || 0), ++Mx[b])
        : c !== void 0
        ? ((Lx[a] = Lx[a] || {}), (Lx[a][b] = Math.round(c)))
        : ((Kx[a] = Kx[a] || {}), (Kx[a][b] = (Kx[a][b] || 0) + 1)));
  }
  function Ox(a) {
    var b = a.eventId,
      c = a.Ya,
  ...
  function Qx() {
    for (
      var a = [], b = pa(Object.keys(Mx)), c = b.next();
      !c.done;
      c = b.next()
    ) {
      var d = c.value;
  ...
  function Wx(a, b, c, d) {
    ...
    if (n && n.length) {
      var p = n[0],
        q = Vx(p.index, { onSuccess: g, onFailure: h, terminate: m }, c, d);
      if (!q) return null;
      g = q;
      h = p.Jj === 2 ? m : q;
    }
  ...
  var cy = function (a, b) {
    for (var c = [], d = 0; d < jf.length; d++)
      if (a[d]) {
        ...
        var f = sx(b.jc);
        try {
          var g = Vx(d, { onSuccess: f, onFailure: f, terminate: f }, b, d);
          if (g) {
            var h = e[Ie.ra];
            if (!h)
              throw Error("Error: No function name given for function call.");
  ...
  var ey = function (a, b) {
    ...
    var c = a["gtm.triggers"] && String(a["gtm.triggers"]),
      d = dy.J(a.event, c ? String(c).split(",") : []);
      ...
      consent: function (a, b) {
        if (a.length === 3) {
          ...
          d === "default"
            ...
            : d === "update"
            ? mm(e, c)
            : d === "declare" && b.fromContainerExecution && km(e);
        }
      },
      event: function (a, b) {
        var c = a[1];
        if (!(a.length < 2) && l(c)) {
          ...
          var q = d,
            r = q && q[Q.g.Zb];
          r === void 0 &&
            ((r = Mi(Q.g.Zb, 2)), r === void 0 && (r = "default"));
  ...
  function fz(a, b) {
    ...
    if (!a.event) return !1;
    typeof d !== "number" &&
      ((d = Di()), (a["gtm.uniqueEventId"] = d), Pi("gtm.uniqueEventId", d));
    return ly(a);
  }
  function gz(a) {
    ...
    for (var a = !1, b; !az && (b = hz()); ) {
      ...
      if (d == null) az = !1;
        ...
        try {
          ...
          if (typeof r === "number") {
            for (var t = Xy[String(r)] || [], u = 0; u < t.length; u++)
              Zy.push(jz(t[u]));
            t.length && Zy.sort(bz);
            delete Xy[String(r)];
            r > Wy && (Wy = r);
          ...
          lk.push(function (d) {
            ...
            if (U(66)) {
              ...
              a: {
                  ...
                  b: {
                    if (a.scriptSource) {
                      for (
                        var m = Fi.M,
                          n = V(a.scriptSource),
                          p = m ? n.pathname : "" + n.hostname + n.pathname,
                          q = H.scripts,
                          r = "",
                          t = 0;
                        t < q.length;
                        ...
                        if (
                          !(
                            u.innerHTML.length === 0 ||
                            (!m &&
                              u.innerHTML.indexOf(
                                a.scriptContainerId || "SHOULD_NOT_BE_SET"
                              ) < 0) ||
                            u.innerHTML.indexOf(p) < 0
                          )
                        ) {
                          if (
                            u.innerHTML.indexOf("(function(w,d,s,l,i)") >= 0
                          ) {
                            h = String(t);
                            break b;
                          }
                ...
                var w = [].slice.call(document.scripts);
                g = a.scriptElement ? String(w.indexOf(a.scriptElement)) : "-1";
              }
              f.call(e, ["hlo", g]);
              e.push(["lst", wz(a)]);
            }
  ...
  var DA = function (a, b, c) {
    ...
    CA = function (a) {
      ...
      return FA.indexOf(b) < 0 ||
        (b === "input" && GA.indexOf(a.type.toLowerCase()) >= 0)
        ? !1
        : !0;
    },
    FA = ["input", "select", "textarea"],
    GA = ["button", "hidden", "image", "reset", "submit"];
  function KA(a) {}
  ...
  var SA = function () {
      Ec(H, "change", function (a) {
        for (var b = 0; b < NA.length; b++) NA[b](a);
      });
      ...
      if (MA[c]) MA[c].push(b);
        ...
        NA.push(function (f) {
          ...
          if (g) {
            var h = EA(g);
            if (h) {
              var m = UA(h, "gtmFormInteractId", function () {
                  return PA++;
                }),
                n = UA(g, "gtmFormInteractFieldId", function () {
                  return QA++;
                }),
                p = e[m];
              p
                ? (p.Qb &&
                    (G.clearTimeout(p.Qb),
                    p.zb.dataset.gtmFormInteractFieldId !== n && TA(p, d)),
                  (p.zb = g),
                  VA(p, d, a))
                : ((e[m] = { form: h, zb: g, Qe: 0, Qb: null }),
                  VA(e[m], d, a));
            }
          }
        });
    ...
    TA = function (a, b) {
      ...
      e["gtm.interactedFormFieldPosition"] = DA(c, d, "gtmFormInteractFieldId");
      e["gtm.interactSequenceNumber"] = a.Qe;
  ...
  var ZA = function (a, b, c) {
    ...
    $A = function (a, b) {
      var c = wA("pix.fsl", a ? "nv.mwt" : "mwt", 0);
      G.setTimeout(b, c);
    },
    aB = function (a, b, c, d, e) {
      var f = wA("pix.fsl", c ? "nv.mwt" : "mwt", 0),
        g = wA("pix.fsl", c ? "runIfCanceled" : "runIfUncanceled", []);
    ...
    cB = function () {
      ...
      Ec(
        ...
        function (c) {
          ...
          if (aB(d, m, e, f, g)) return (h = !1), c.returnValue;
          $A(e, m);
      ...
      HTMLFormElement.prototype.submit = function () {
        ...
        aB(c, e, !1, YA(c)) ? (b.call(c), (d = !1)) : $A(!1, e);
      };
    };
  function dB(a, b) {
    ...
    if (d) {
      ...
      AA("pix.fsl", "mwt", h, 0);
      f || AA("pix.fsl", "nv.mwt", h, 0);
    }
    var m = function (n) {
      n.push(g);
      return n;
    };
    AA("pix.fsl", "runIfUncanceled", m, []);
    f || AA("pix.fsl", "runIfCanceled", m, []);
    wA("pix.fsl", "init") || (cB(), xA("pix.fsl", "init", !0));
  }
  ...
  function kB(a) {
    return a ? { originatingEntity: jB(a) } : {};
  }
  function sB(a) {
    var b = ni.zones;
    return b
            ...
            if (h) {
              ...
              if (m !== null && n !== null) {
                ...
                p
                  ? (p.Qb &&
                      (G.clearTimeout(p.Qb),
                      p.zb.getAttribute("data-gtm-form-interact-field-id") !==
                        n && wC(p, d)),
                    (p.zb = g),
                    zC(p, d, b))
                  : ((e[m] = { form: h, zb: g, Qe: 0, Qb: null }),
      ...
      if (qb(d))
        try {
          c[a] = function (e, f, g) {
            ...
            var h = G.location.href;
            b({ source: a, state: e, url: jj(V(h)), ia: ij(V(h), "fragment") });
          };
        } catch (e) {}
    },
    SC = function (a) {
  ...
  function UC(a, b) {
    ...
    if (!wA(d, "init", !1)) {
      ...
      d === "ehl"
        ? ((f = function (h) {
            for (var m = 0; m < NC.length; m++) NC[m](h);
          }),
          (b = vA(b)),
          PC(b, e),
          xA(d, "reg", PC))
        : (f = OC("gtm.historyChange"));
      TC(f);
      SC(f);
      QC("pushState", f);
      QC("replaceState", f);
      ...
      var a = 0,
        b = function (c) {
          ...
          if (
            d &&
            c.which !== 3 &&
            !(c.uh || (c.timeStamp && c.timeStamp === a))
          ) {
            a = c.timeStamp;
            d = Jc(d, ["a", "area"], 100);
            if (!d) return c.returnValue;
  ...
  var bD = function (a) {
    ...
    gD = function () {
      function a() {
        f ? (e = G.setTimeout(a, c)) : ((e = 0), dD(), eD(b));
        f = !1;
      }
      function b() {
        d && $C();
        e ? (f = !0) : ((e = G.setTimeout(a, c)), xA("sdl", "pending", !0));
      }
      var c = 250,
        d = !1;
    ...
    eD = function (a, b) {
      wA("sdl", "init", !1) &&
        !hD() &&
        (b ? Fc(G, "scrollend", a) : Fc(G, "scroll", a),
        Fc(G, "resize", a),
        xA("sdl", "init", !1));
    },
    dD = function () {
      var a = $C(),
        b = a.bh,
        c = a.eh,
        d = (b / aD.scrollWidth) * 100,
        e = (c / aD.scrollHeight) * 100;
      iD(b, "horiz.pix", "PIXELS", "horizontal");
      iD(d, "horiz.pct", "PERCENT", "horizontal");
      iD(c, "vert.pix", "PIXELS", "vertical");
      iD(e, "vert.pct", "PERCENT", "vertical");
      xA("sdl", "pending", !1);
    },
    iD = function (a, b, c, d) {
      var e = bD(b),
    ...
    jD = function () {
      ...
      return function () {
        var c = qs(),
          d = c.height;
        a = Math.max(aD.scrollLeft + c.width, a);
        b = Math.max(aD.scrollTop + d, b);
        return { bh: a, eh: b };
      };
    },
    hD = function () {
      return !!(
        Object.keys(bD("horiz.pix")).length ||
        Object.keys(bD("horiz.pct")).length ||
        Object.keys(bD("vert.pix")).length ||
        Object.keys(bD("vert.pct")).length
      );
    };
  function lD(a, b) {
    var c = this;
    ...
    switch (d.horizontalThresholdUnits) {
      case "PIXELS":
        cD(d.horizontalThresholds, b, "horiz.pix");
        break;
      case "PERCENT":
        cD(d.horizontalThresholds, b, "horiz.pct");
    }
    switch (d.verticalThresholdUnits) {
      case "PIXELS":
        cD(d.verticalThresholds, b, "vert.pix");
        break;
      case "PERCENT":
        cD(d.verticalThresholds, b, "vert.pct");
    }
    wA("sdl", "init", !1)
      ? wA("sdl", "pending", !1) ||
        I(function () {
        ...
        var n = a(),
          ...
          r =
            h !== void 0
              ...
              ? 0
              : Math.round((q / p) * 100),
          t = H.hidden ? !1 : rs(c) >= 0.5;
        d();
        var u = void 0;
        b !== void 0 && (u = [b]);
        var v = BA(c, "gtm.video", u);
  ...
  var sD = function (a, b, c) {
      var d = a.map(function (g) {
        return { Ha: g, Pe: g, Ne: void 0 };
      });
      if (!b.length) return d;
      var e = b.map(function (g) {
        return { Ha: g * c, Pe: void 0, Ne: g };
      });
    ...
    vD = function (a, b) {
      ...
      function f(E) {
        switch (E) {
          case 1:
            ...
            x = a.getPlaybackRate();
            b.Wg ? cz(t.createEvent("start")) : t.rd();
            u = sD(b.Mh, b.Lh, a.getDuration());
            return g(E);
          default:
            return f;
        }
      ...
      function h(E) {
        ...
        switch (E) {
          ...
          case 3:
            ...
            C =
              Math.abs(((Cb().getTime() - A) / 1e3) * x - F) > 1
                ? "seek"
                : C || "buffering";
            a.getCurrentTime() && (b.Vg ? cz(t.createEvent(C)) : t.rd());
            q();
            return m;
          case -1:
            return e(E);
      ...
      function n() {
        ...
        b.Ug && cz(t.createEvent("complete", 1));
        return e(-1);
      }
      function p() {}
      function q() {
      ...
      function r() {
        if (u.length && x !== 0) {
          ...
          c = function () {
            ...
            u.length > 0 &&
              u[0].Ha === C.Ha &&
              (u.shift(), cz(t.createEvent("progress", C.Ne, C.Pe)));
            r();
          };
    ...
    wD = function (a, b) {
      if (
        !a.getAttribute("data-gtm-yt-inspected-" + b.Cb) &&
        (nc(a, "data-gtm-yt-inspected-" + b.Cb), yD(a, b.ze))
      ) {
        a.id || (a.id = zD());
        var c = G.YT,
          d = c.get(a.id);
      ...
      if (AD(c, "embed/")) {
        ...
        if (b) {
          ...
          c.indexOf("origin=") > -1
            ? (d = c + e + "enablejsapi=1")
            : (qD ||
                ((qD = H.location.protocol + "//" + H.location.hostname),
                H.location.port && (qD += ":" + H.location.port)),
              (d = c + e + "enablejsapi=1&origin=" + encodeURIComponent(qD)));
          var f;
          f = Ub(d);
          a.src = Sb(f).toString();
          return !0;
    ...
    AD = function (a, b) {
      ...
      for (var c = 0; c < pD.length; c++)
        if (a.indexOf("//" + pD[c] + "/" + b) >= 0) return !0;
      return !1;
    },
    zD = function () {
      var a = Math.round(Math.random() * 1e9) + "";
      return H.getElementById(a) ? zD() : a;
    };
  function BD(a, b) {
    var c = this;
    K(this.getName(), ["dustOptions:!PixieMap", "triggerId:?*"], arguments);
    ...
    var d = !!a.get("captureStart"),
      ...
      g = uD(J(a.get("progressThresholdsPercent"))),
      h = tD(J(a.get("progressThresholdsTimeInSeconds"))),
      m = !!a.get("fixMissingApi");
    if (!(d || e || f || g.length || h.length)) return;
    var n = { Wg: d, Ug: e, Vg: f, Lh: g, Mh: h, ze: m, Cb: b },
      p = G.YT,
      q = function () {
        xD(n);
      };
    ...
    I(function () {
      for (
        ...
        if (AD(w, "iframe_api") || AD(w, "player_api")) return b;
      }
      for (
        var y = H.getElementsByTagName("iframe"), x = y.length, B = 0;
        B < x;
        B++
      )
        if (!rD && yD(y[B], n.ze))
          return Ac("https://www.youtube.com/iframe_api"), (rD = !0), b;
    });
    return b;
  }
  ...
  function kF() {
    ...
    N(this, "read_container_data"),
      U(36) && jF
        ? (a = jF)
        : (a.set("containerId", "G-E5B3WC78SV"),
          a.set("version", "1"),
  ...
  var HF = !1,
    IF = function (a) {
      ...
      return !(
        !((U(54) && U(55) && "fetch" in G) || qc.sendBeacon) ||
        e ||
        m ||
        f ||
        g ||
  ...
  var QF = function (a, b, c) {
      ...
      if (d === void 0 || c <= d)
        (a.C[Q.g.nb] = b), (a.metadata.client_id_source = c);
    },
    TF = function (a, b) {
      var c;
  ...
  var XF = function (a, b, c) {
      ...
      if (!d) return b;
      var e,
        f = yb((e = W(c.o, Q.g.kd)) != null ? e : 30);
      if (
        !(Math.floor(c.metadata.event_start_timestamp_ms / 1e3) > d.Je + f * 60)
      )
        return a;
      var g = VF(b);
      if (!g) return a;
      g.Lc = d.Lc + 1;
      var h;
      return (h = WF(g.sessionId, g.Lc, g.zd, g.Je, g.Ah, g.Gc, g.we)) != null
        ? h
        : b;
    },
    $F = function (a, b) {
  ...
  var cG = function (a) {
    ...
    dG = function (a, b) {
      var c = pp(!0);
      return c._up !== "1" ? {} : { clientId: c[a], Qf: c[b] };
    },
    eG = function (a, b, c) {
      var d = pp(!0),
        e = d[b];
    ...
    gG = function (a) {
      var b = cG(a) || {},
        ...
        f = {};
      zp(b[Q.g.Bc], !!b[Q.g.X]) &&
        ((f = eG(a, d, e)), f.clientId && f.Qf && (fG = !0));
      b[Q.g.X] &&
        wp(
          function () {
            var g = {},
  ...
  var kG = function (a, b) {
    ...
    nG = function (a) {
      ...
      if (Fi.F) return { url: "" + Gi() + "/g/collect", endpoint: 16 };
      var c = kt(a),
        d = W(a.o, Q.g.lb);
    ...
    vG = function (a, b, c) {
      ...
      z(a.C, function (t, u) {
        if (u !== void 0 && !Yh.hasOwnProperty(t)) {
          ...
          t !== Q.g.Qd
            ? (v = !1)
            : a.metadata.euid_mode_enabled || lt(a)
            ? ((d.ecid = w), (v = !0))
            : (v = void 0);
          if (!v && t !== Q.g.bf) {
            var y = u;
      ...
      var r = nG(a);
      dg.call(this, { na: d, Mc: f, ih: e }, r.url, lt(a), void 0, r.endpoint);
    };
  za(vG, dg);
  var wG = function (a) {
      this.F = a;
    ...
    IG = function (a, b, c, d) {
      ...
      if (d && !HF) EG(g, c);
        ...
        U(54)
          ? ("fetch" in G
              ? U(55)
                ? Nc(a + "?" + FG(m, "_z=fetch"), c, { Sn: !0 }) ||
                  HG(a, FG(m, "_z=failedfetch"), c)
                : HG(a, FG(m, "_z=sendBeacon"), c)
              : HG(a, FG(m, "_z=nofetch"), c),
            (h = !0))
          : (h = !1);
        h || HG(a, b, c);
      }
    ...
    JG = function (a, b) {
      ...
      if (d || e) {
        ...
        if (e) {
          ...
          if (!g) {
            var t =
              f && f.indexOf("google.") === 0 && f != "google.com"
  ...
  var OG = function (a, b, c) {
      c === void 0 && (c = {});
      if (typeof b === "object") for (var d in b) OG(a + "." + d, b[d], c);
      else c[a] = b;
      return c;
    },
    PG = function (a) {
  ...
  var QG = window,
    ...
    SG = function (a) {
      ...
      if (
        (b && b.ioo && b.ioo()) ||
        RG.documentElement.hasAttribute("data-google-analytics-opt-out") ||
        (a && QG["ga-disable-" + a] === !0)
      )
        return !0;
      try {
      ...
      for (
        var d = [], e = String(RG.cookie).split(";"), f = 0;
        f < e.length;
        f++
      ) {
        var g = e[f].split("="),
  ...
  ca.Cm = function (a, b, c) {
    ...
    if (e)
      if (c.eventMetadata.is_external_event && a.charAt(0) === "_")
        ...
        var g = [Q.g.W];
        if (jr(f, Q.g.Wb, W(f.o, Q.g.Wb)) || lt(f))
          g.push(Q.g.T), g.push(Q.g.P);
        $t(function () {
          qm(function () {
            d.Dm(f);
          }, g);
  ...
  ca.Am = function (a, b, c) {
    ...
    if (U(51) && a === Q.g.da && jr(c, "ga4_ads_linked", !1)) {
      var e = function () {
          ...
          f.metadata.speculative || f.isAborted || $u(f);
        },
        f = new ir(d, a, b);
  ...
  ca.Dm = function (a) {
    ...
    try {
      ...
      if (Zt.yl.replace(/\s+/g, "").split(",").indexOf(a.eventName) >= 0)
        a.isAborted = !0;
      else {
        var d = nt(a);
      ...
      a.metadata.is_merchant_center
        ...
        : jr(a, "ccd_add_1p_data", !1) && (a.metadata.euid_mode_enabled = !0);
          ...
          p === null
            ...
            : (n.enable_code && Ya(p) && (a.metadata.user_data_from_code = p),
              Ya(n.selectors) &&
                ...
                (a.metadata.user_data_from_manual = Ti(n.selectors)));
        }
      }
      if (
        U(52) &&
        !U(51) &&
        jr(a, "ga4_ads_linked", !1) &&
        a.eventName === Q.g.da
      ) {
        ...
        if (q) {
          ...
          Gr({ sd: q, xd: W(a.o, Q.g.xa) || {}, Dd: W(a.o, Q.g.Xa), kc: r });
        }
      }
      var t = this.Xj,
        u;
      ...
      if (W(a.o, Q.g.Ib) && W(a.o, Q.g.Xb))
        O ? QF(a, O, 1) : (P(127), (a.isAborted = !0));
      else {
        var S = O ? 1 : 8;
      ...
      ia &&
        ...
        (a.metadata.join_timer_sec = Math.max(
          0,
          ia.Ah - Math.max(0, R - ia.Je)
        ));
      var Ja = !1;
      ia ||
        ((Ja = a.metadata.is_first_visit = !0),
        (ia = {
          sessionId: String(R),
          Lc: 1,
          zd: !1,
      ...
      a.metadata.euid_mode_enabled
        ? W(a.o, Q.g.Da)
          ? (ia.Gc = !0)
          : (ia.Gc && !U(11) && (ia.we = void 0), (ia.Gc = !1))
        : (ia.Gc = !1);
      var Ba = ia.we;
      if (a.metadata.euid_mode_enabled || lt(a)) {
        ...
        if (Rf === void 0 || be <= Rf)
          (a.C[Q.g.Qd] = Le), (a.metadata.enhanced_client_id_source = be);
      }
      M
        ? (a.copyToHitData(Q.g.ub, ia.sessionId),
          a.copyToHitData(Q.g.ce, ia.Lc),
          a.copyToHitData(Q.g.be, ia.zd ? 1 : 0))
        : ((a.C[Q.g.ub] = ia.sessionId),
          (a.C[Q.g.ce] = ia.Lc),
          (a.C[Q.g.be] = ia.zd ? 1 : 0));
      a.metadata[Q.g.bf] = ia.Gc ? 1 : 0;
      eH(a);
      if (!W(a.o, Q.g.Xb) || !W(a.o, Q.g.Ib)) {
        ...
        if (th) {
          ...
          if (U(79) && Sf && Sf.indexOf("?") === 0)
            for (
              var Sw = Sf.substring(1).split("&"), Sn = 0;
              Sn < Sw.length;
              ++Sn
            ) {
              var Sj = Sw[Sn].split("=");
        ...
        U(56) && nr() && a.copyToHitData(Q.g.ed, "1");
      }
      ...
      if (
        ...
        var Xw = kt(a);
        (a.metadata.is_session_start || W(a.o, Q.g.rg)) &&
          (a.metadata.create_dc_join = !!Xw);
        var Yw;
      ...
      if (!a.metadata.is_merchant_center && sj(a.o)) {
        var ax = cG(a) || {},
          PI =
            (zp(ax[Q.g.Bc], !!ax[Q.g.X]) ? pp(!0)._fplc : void 0) ||
            (Fo("FPLC", void 0, void 0, Q.g.W).length > 0 ? void 0 : "0");
        a.C._fplc = PI;
      }
      if (W(a.o, Q.g.dd) !== void 0) a.copyToHitData(Q.g.dd);
        ...
        a: {
          if (fG) {
            ...
            if (Vn && Vn[Q.g.X])
              for (
                var cx = ij(V(a.C[Q.g.Fa]), "host", !0), Vj = Vn[Q.g.X], uh = 0;
                uh < Vj.length;
                uh++
              )
        ...
        if (!(Un = Uj)) {
          ...
          if ((Wj = bx))
            a: {
              for (
                var dx = bx.include_conditions || [],
                  QI = ij(V(a.C[Q.g.Fa]), "host", !0),
                  Wn = 0;
                Wn < dx.length;
                Wn++
              )
      ...
      lt(a) &&
        (ot(a, "gcd", oo(a.o)), cm() && W(a.o, Q.g.ja) && ot(a, "adr", 1));
      if (lt(a)) {
        var gx = Er();
      ...
      lt(a) &&
        (a.metadata.speculative && ot(a, "sp", 1),
        a.metadata.is_syn && ot(a, "syn", 1),
        a.metadata.em_event && (ot(a, "em_event", 1), ot(a, "sp", 1)));
      U(86) &&
        lt(a) &&
        W(a.o, Q.g.Ea) !== !1 &&
        bu("join-ad-interest-group") &&
      ...
      Xn || gH || ((gH = !0), rl(""), (Xn = bu("attribution-reporting")));
      Xn && (a.C[Q.g.Vb] = "1");
      ...
      (px ||
        ik(vh) ||
        (vh && vh.parent && vh.context && vh.context.source === 5)) &&
        MF(19);
      !this.aa && a.metadata.em_event && MF(18);
      var Yn = a.metadata.event_usage;
      if (Array.isArray(Yn)) for (var Zn = 0; Zn < Yn.length; Zn++) MF(Yn[Zn]);
      var qx = nb("GA4_EVENT");
      qx && (a.C._eu = qx);
      ...
      if (lt(a)) {
        ...
        if (a.eventName === "page_view" || YI)
          XG(this, a, Q.g.T), XG(this, a, Q.g.P);
      }
      this.M.Ph();
      a.copyToHitData(Q.g.sg);
      W(a.o, Q.g.ae) && ((a.C[Q.g.ae] = !0), lt(a) || VG(a));
      if (a.isAborted) {
        a.o.onFailure();
        LF();
        return;
  ...
  ca.Tm = function (a) {
    ...
    if (!this.Qa) {
      ...
      om([Q.g.P, Q.g.W], function () {
        ...
        e &&
          !c &&
          ((g = !0), (m.is_consent_update = !0), (h[Q.g.eg] = hi[Q.g.P]));
        if (g) {
          var r = sy(b.R, Q.g.Nc, h);
          uy(r, a.o.eventId, { eventMetadata: m });
        }
        d = f;
        c = e;
      });
  ...
  var dH = function (a) {
    ...
    fH = function (a) {
      ...
      a.metadata.is_first_visit &&
        (a.metadata.is_first_visit_conversion = b(nt(a, "first_visit")));
      a.metadata.is_session_start &&
        (a.metadata.is_session_start_conversion = b(nt(a, "session_start")));
    },
    gH = !1;
  function cH(a) {
    z(a, function (c) {
  ...
  qI.getItem = function (a) {
    ...
    var c = tA(this).xb();
    rI[c] && (b = rI[c].hasOwnProperty("gtm." + a) ? rI[c]["gtm." + a] : null);
    return b;
  };
  ...
  qI.removeItem = function (a) {
    N(this, "access_template_storage");
    var b = tA(this).xb();
    if (!rI[b] || !rI[b].hasOwnProperty("gtm." + a)) return;
    delete rI[b]["gtm." + a];
  };
  qI.clear = function () {
    N(this, "access_template_storage"), delete rI[tA(this).xb()];
  };
  ...
  (Z.securityGroups.gct = ["google"]),
    (function () {
      ...
      (function (b) {
        ...
        c[g] = h;
        var m = Yj(b.vtp_trackingId);
        qn(m, c);
        kH(m, b.vtp_gtmEventId);
  ...
  (Z.securityGroups.get = ["google"]),
    (Z.__get = function (a) {
      ...
      var f = sy(String(b.streamId), d, c);
      uy(f, e.eventId, e);
      a.vtp_gtmOnSuccess();
    }),
    (Z.__get.D = "get"),
  ...
  (function (a) {
    ...
    var g = function (u) {
        ...
        var x = {
          ...
          data: {
            ...
            debug: !1,
            id: Nf.ctid,
            targetRef: { ctid: Nf.ctid, isDestination: Ej.he },
            aliases: Hj(),
            destinations: Kj(),
          },
        };
    ...
    try {
      ...
      if (Cj().canonical[a]) {
        ...
        if (!wi)
          for (
            var S = Ll() ? Hi(Fi.R) : Hi(Fi.aa), ba = 0;
            ba < hm.length;
            ba++
          ) {
            var aa = hm[ba],
        ...
        zj && (mk(Ck), G.setInterval(Bk, 864e5));
        Nk();
        mk(eA);
        mk(Jx);
        mk(cv);
